...
User Side Blank Scroll Fix:
- CSS-only fix.
- Prevents extra blank/rubber scroll below page content.
- Keeps user design and all app logic unchanged.
- Uses overscroll-behavior and layout height fixes.
